...
public class GetWeeklyKillsBonus {
    ...
    public void test()
    {
        ...
        assertEquals(600, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(700, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(700, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(700, game.GetWeeklyKillsBonus(player));
        ...
        assertEquals(700, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(800, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(800, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(800, game.GetWeeklyKillsBonus(player));
        ...
        assertEquals(800, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(900, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(900, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(900, game.GetWeeklyKillsBonus(player));
        ...
        assertEquals(900, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(1000, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(1000, game.GetWeeklyKillsBonus(player));
        player.IncrementKills();
        assertEquals(1000, game.GetWeeklyKillsBonus(player));
